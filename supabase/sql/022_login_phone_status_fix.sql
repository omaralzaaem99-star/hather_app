-- 022: Harden login phone status (RLS-safe + md5 + phone format matching).
-- Apply if you already ran an older 021, or run this instead of re-running 021.

alter table if exists public.login_phone_probe_log enable row level security;
